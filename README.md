...
1. Run the Application from Eclipse and follow the instructions on each tab of the application, the code blocks in each ViewController illustrating how to Create Read Update and Delete using the Android LoopBack.framework

##### Getting Started with the Android [LoopBack.framework](https://github.com/strongloop-community/loopback-ios-sdk)  SDK
If you are creating a new Android Application or want to integrate an existing App you can use the LoopBack Android libraries.
